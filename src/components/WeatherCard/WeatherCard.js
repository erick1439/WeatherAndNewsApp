...
const WeatherCard = ({city, countryCode, weatherInfo}) => {
        ...
        <Card className="card">
            <Card.Body>
                <div className="card-top">
                    <div className="city">
                        <Card.Title className="font-weight-bold">{city}</Card.Title>
                        <Card.Text className="temp">{Math.round(weatherInfo.temp)} &deg;F</Card.Text>
                    </div>
                    <div className="weatherImage">
                        <Card.Img src={weatherInfo.icon} />
                    </div>
                </div>
                <div className="card-info">
                    ...
                    <Card.Text className="flike">
                        Feels like:<br />
                        {weatherInfo.feelsLike}</Card.Text>
                    ...
                    <Card.Text className="mintemp">
                        ...
                        {Math.round(weatherInfo.temp_min)}</Card.Text>
                    <Card.Text className="maxtemp">
                        ...
                        {Math.round(weatherInfo.temp_max)}
                    </Card.Text>
